#!/bin/bash
# PRJNA598825 QIIME2 流程：双端 2×300bp，V3-V4，341F/805R（Illumina标准），拭子
# 数据类型：双端 paired-end，引物未截除
#
# 用法：
#   conda activate qiime2-amplicon-2023
#   cd /home/usr/yel/exp-OLP_meta/pipeline
#   nohup bash scripts/25_qiime2_PRJNA598825.sh > logs/qiime2_PRJNA598825.log 2>&1 &
