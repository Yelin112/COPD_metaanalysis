#!/bin/bash
# PRJNA690677 QIIME2 流程：双端 2×241bp，V3-V4，338F/806R，龈下菌斑
# 数据类型：双端 paired-end，引物未截除
#
# 用法：
#   conda activate qiime2-amplicon-2023
#   cd /home/usr/yel/exp-OLP_meta/pipeline
#   nohup bash scripts/26_qiime2_PRJNA690677.sh > logs/qiime2_PRJNA690677.log 2>&1 &
...
# Step 4: DADA2
# V3 扩增子 ~468bp（去引物后 ~428bp），241bp reads 不截断以保留合并重叠
# 合并重叠估算：241+241-428=54bp，reads 较短，截断会进一步压缩重叠
